...
constexpr BYTE ID_Menu_PlayThenTimeout = 9;//优先播放再看超时
constexpr BYTE ID_Menu_HideTray = 10;
constexpr BYTE ID_Menu_AutoRun = 11;
constexpr BYTE ID_Menu_About = 12;
constexpr BYTE ID_Menu_Quit = 13;